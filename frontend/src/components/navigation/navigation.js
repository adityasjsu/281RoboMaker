...
const iotendpoint = "a3im3ewiuzr81n-ats.iot.us-east-2.amazonaws.com";
const iotclientId =
  "deliverychallengeroot-RoboMakerDeliveryChallengeThing-R3JYGKM31VEV";
const subscribe_topic =
  "deliverychallengeroot-RoboMakerDeliveryChallengeThing-R3JYGKM31VEV/pub";
const publish_topic =
  "deliverychallengeroot-RoboMakerDeliveryChallengeThing-R3JYGKM31VEV/sub";
const PoolId = "us-east-2:3030385b-54b8-4bcd-b06d-6a9713328583";

// const region = "us-east-2";
// const iotendpoint = "a3ka5w8uqglf2j-ats.iot.us-east-2.amazonaws.com";
// const iotclientId =
//   "deliverychallengeroot-RoboMakerDeliveryChallengeThing-11K4DZ447HPJ2";
// const subscribe_topic =
//   "deliverychallengeroot-RoboMakerDeliveryChallengeThing-11K4DZ447HPJ2/pub";
// const publish_topic =
//   "deliverychallengeroot-RoboMakerDeliveryChallengeThing-11K4DZ447HPJ2/sub";
// const PoolId = "us-east-2:fb863eeb-ae6e-48cb-b73b-61468e3152c0";

const useStyles = (theme) => ({
  title: {
    color: "rgb(128, 130, 126)",
    fontSize: 45,
    textAlign: "center",
    marginTop: "30px",
    marginBottom: "0px",
...
class Controller extends Component {
  ...
  //control
  move_forward_down = () => {
    this.setState({ MoveAction: "forward" });
    console.log("move_forward pressed");
    SyncJobFunction("forward");
  };
  move_forward_up = () => {
    this.setState({ MoveAction: "" });
    console.log("move_forward released");
  };
  move_left_down = () => {
    this.setState({ MoveAction: "left" });
    console.log("move_left pressed");
    SyncJobFunction("left");
  };
  move_left_up = () => {
    this.setState({ MoveAction: "" });
    console.log("move_left released");
  };
  move_right_down = () => {
    this.setState({ MoveAction: "right" });
    console.log("move_right pressed");
    SyncJobFunction("right");
  };
  move_right_up = () => {
    this.setState({ MoveAction: "" });
    console.log("move_right released");
  };
  move_backward_down = () => {
    this.setState({ MoveAction: "backward" });
    console.log("move_backward pressed");
    SyncJobFunction("backward");
  };
  move_backward_up = () => {
    this.setState({ MoveAction: "" });
    console.log("move_backward released");
  };
  move_stop_down = () => {
    this.setState({ MoveAction: "stop" });
    console.log("move_stop pressed");
    SyncJobFunction("stop");
  };
  move_stop_up = () => {
    this.setState({ MoveAction: "" });
    console.log("move_stop released");
  };
    ...
    return (
      ...
      >
        <div className="forward">
          <button
            className="button move_button"
            onMouseDown={this.move_forward_down}
            onMouseUp={this.move_forward_up}
          >
            ↑
          </button>
        </div>
        <div className="left">
          <button
            className="button move_button"
            onMouseDown={this.move_left_down}
            onMouseUp={this.move_left_up}
          >
            ←
          </button>
        </div>
        <div className="stop">
          <button
            className="button move_button"
            onMouseDown={this.move_stop_down}
            onMouseUp={this.move_stop_up}
          >
            ・
          </button>
        </div>
        <div className="right">
          <button
            className="button move_button"
            onMouseDown={this.move_right_down}
            onMouseUp={this.move_right_up}
          >
            →
          </button>
        </div>
        <div className="backward">
          <button
            className="button move_button"
            onMouseDown={this.move_backward_down}
            onMouseUp={this.move_backward_up}
          >
            ↓
          </button>
        </div>
...
class Navigation extends Component {
  ...
  render() {
    return (
      // style={{ backgroundColor: "rgb(167, 131, 199)" }}
      <div className="goal">
        ...
        <div className="goal_value_heading">
          <input
            className="input_field"
            type="text"
            onChange={this.onChangeGoalHeading}
  ...
  go_to_target() {
    GoToTargetFunction(
      NavigationControlInstance.state.x,
      NavigationControlInstance.state.y,
      NavigationControlInstance.state.heading
    );
  }
    ...
    return (
      <div className="save">
        <div className="save_button">
          <button className="button action_button" onClick={this.map_save}>
            Save Map
          </button>
        </div>
      </div>
